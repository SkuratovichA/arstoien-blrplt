...
resource "aws_wafv2_web_acl" "main" {
  ...
  # Anonymous IP List (blocks VPNs, Tor, proxies)
  rule {
    name     = "AWSManagedRulesAnonymousIpList"
    priority = 6

    override_action {
      count {} # Just count for now, can be changed to block
    }
...
# Note: WAF association with CloudFront is done via the CloudFront distribution
# using the web_acl_id attribute. This is handled in the cloudfront module.
